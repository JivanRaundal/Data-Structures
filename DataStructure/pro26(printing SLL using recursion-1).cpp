//	printing linked list using recursion using independent function.
...
int main()
{
	...
	cout<<"\nList using recursion in forward order :\n";
	rec_show(obj.head);
	
	cout<<"\nList using recursion in reverse order :\n";
	rec_show_rev(obj.head);
